...
- Give user an option for a matrix cell values to use multiplication instead of addition (so instead of <a-th prime> ADD <b-th prime> be <a-th prime> MULTIPLY <b-th prime>)
